...
import org.example.jooq.tables.Product.ProductPath;
...
public class InvoiceItem extends TableImpl<Record> {
    ...
    /**
     * The column <code>invoice_item.version</code>.
     */
     ...
     */
    public final TableField<Record, BigDecimal> QUANTITY = createField(DSL.name("quantity"), SQLDataType.DECIMAL(19, 4).nullable(false), this, "");

    /**
     * The column <code>invoice_item.unit_value</code>.
     */
    public final TableField<Record, BigDecimal> UNIT_VALUE = createField(DSL.name("unit_value"), SQLDataType.DECIMAL(19, 4).nullable(false), this, "");

    /**
     * The column <code>invoice_item.product_id</code>.
     */
    public final TableField<Record, Integer> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>invoice_item.invoice_id</code>.
     */
    public final TableField<Record, Integer> INVOICE_ID = createField(DSL.name("invoice_id"), SQLDataType.INTEGER.nullable(false), this, "");

    private InvoiceItem(Name alias, Table<Record> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private InvoiceItem(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> InvoiceItem(Table<O> path, ForeignKey<O, Record> childPath, InverseForeignKey<O, Record> parentPath) {
     ...
     */
    public static class InvoiceItemPath extends InvoiceItem implements Path<Record> {

        private static final long serialVersionUID = 1L;
        public <O extends Record> InvoiceItemPath(Table<O> path, ForeignKey<O, Record> childPath, InverseForeignKey<O, Record> parentPath) {
            super(path, childPath, parentPath);
        }
        private InvoiceItemPath(Name alias, Table<Record> aliased) {
            super(alias, aliased);
        }
    ...
    /**
     * Get the implicit join path to the <code>invoice.invoice</code> table.
     */
    ...
    /**
     * Get the implicit join path to the <code>invoice.product</code> table.
     */
